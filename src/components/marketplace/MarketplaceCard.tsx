  ...
  return (
    ...
    >
      <Link
        ...
        className="group block overflow-hidden rounded-[34px] border border-border bg-surface/95 shadow-[0_24px_80px_rgba(15,23,42,0.14)] transition-colors duration-300 hover:border-amber-500/30"
      >
        {/* Cover */}
